...
/// SVG-based booking illustration widget that closely matches the React version
...
<svg width="100%" height="100%" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- First character circle background -->
  <path
    fill="#919EAB"
    fill-opacity="0.24"
  ...
  <!-- Second character circle background -->
  <path
    fill="#919EAB"
    fill-opacity="0.24"
  ...
  <g mask="url(#mask1)">
    ...
    <!-- Character clothing and features -->
    <path
      fill="$primaryLighterHex"
  ...
  <!-- Third character circle background -->
  <path
    fill="#919EAB"
    fill-opacity="0.24"
  ...
  <g mask="url(#mask2)">
    ...
    <path
      fill="$primaryDarkerHex"
      d="M28.689 152.771c3.711 0 4.022 1.737 4.022 3.515 0 2.069-1.757 3.514-4.274 3.514h-.471c-2.381 0-3.802-1.314-3.802-3.514 0-1.778.31-3.515 4.022-3.515h.503zm0 1.004h-.503c-2.957 0-3.016 1.064-3.017 2.427v.084c0 1.145.485 2.51 2.797 2.51h.471c1.925 0 3.268-1.032 3.268-2.51v-.126-.123c-.01-1.283-.18-2.262-3.016-2.262zM39.243 152.771c3.711 0 4.022 1.737 4.022 3.515 0 2.069-1.757 3.514-4.274 3.514h-.471c-2.38 0-3.802-1.314-3.802-3.514 0-1.778.31-3.515 4.022-3.515h.503zm0 1.004h-.503c-2.957 0-3.016 1.064-3.017 2.427v.084c0 1.145.486 2.51 2.797 2.51h.471c1.925 0 3.269-1.032 3.269-2.510v-.126-.123c-.011-1.283-.181-2.262-3.017-2.262z"
    />
