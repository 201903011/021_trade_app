...
/// SVG-based check-out illustration widget that closely matches the React version
class CheckOutIllustration extends StatelessWidget {
  final double? width;
  final double? height;
...
<svg width="200" height="200" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Main character and shopping elements -->
  <path
