...
import 'package:minimals/constants/illustrations/characters/character_10.dart';
import 'package:minimals/theme/use_theme.dart';

/// SVG-based order complete illustration widget that closely matches the React version
class OrderCompleteIllustration extends StatelessWidget {
  final double? width;
  final double? height;
