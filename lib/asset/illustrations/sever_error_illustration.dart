...
import 'package:minimals/constants/illustrations/characters/character_8.dart';
import 'package:minimals/theme/use_theme.dart';

/// SVG-based server error illustration widget that closely matches the React version
class SeverErrorIllustration extends StatelessWidget {
  final double? width;
  final double? height;
  final EdgeInsetsGeometry? margin;
  final EdgeInsetsGeometry? padding;

  const SeverErrorIllustration({
    super.key,
    this.width,
    this.height,
    this.margin,
...
<svg width="100%" height="100%" viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Server rack rows with gradient -->
  <path
