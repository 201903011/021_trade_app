...
const Map<String, String> cn = {
  // Demo section
  'demo.title': '中文',
  'demo.introduction': 'Lorem Ipsum 只是印刷和排版行业的虚拟文本。自15世纪以来，Lorem Ipsum一直是该行业的标准虚拟文本，当时一位不知名的印刷商拿了一个类型的厨房并将其争夺制作一本类型标本书。它不仅幸存了五个世纪，而且还跃入了电子排版，基本上保持不变。',

  // Docs section
  'docs.hi': '你好',
  'docs.description': '需要帮助？\n 请查看我们的文档。',
